...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:SqlDataSource ID="Payee" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [payeeName] FROM [billPayee]"></asp:SqlDataSource>
            <br />
            <br />
            Amount:
            <br />
